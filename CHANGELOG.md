...
- Fixed FreeBSD compilation (https://github.com/fangfufu/httpdirfs/issues/165)
...
- Fixed `--user-agent` option (https://github.com/fangfufu/httpdirfs/issues/159)
...
- Add `--http-header` option (https://github.com/fangfufu/httpdirfs/issues/157)
- Add `--cache-clear` option (https://github.com/fangfufu/httpdirfs/issues/111)
...
- Improved LinkTable caching. LinkTable invalidation is now purely based on
  timeout. (https://github.com/fangfufu/httpdirfs/issues/147)
...
- Cache system: now keep track of the number of times a cache file has been
  opened. - The on-disk cache file no longer gets opened multiple times, if a
  file is opened multiple times. This used to cause inconsistencies between two
  opened cache files.
...
- Cache system: Previously it was possible for Cache_bgdl()'s download offset to
  ...
  This used to cause permanent cache file corruption.
...
- Now caches directory structure on the hard disk. Httpdirfs no longer stutters
  ...
  cache, the local directory structure will be recreated, hence the cache will
  be refreshed. Creating local directory structure involves downloading the
  header for each file, this is what causes stuttering when visiting a new
  directory.
